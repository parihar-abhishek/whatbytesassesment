...
//   return (
//     <div className="flex items-center justify-between px-6 py-4 border border-gray-300">
//       {/* Left side - Company Name */}
//       <h1 className="text-2xl font-bold">WhatBytes</h1>

//       {/* Right side - User Icon with Name */}
//       <div className="flex flex-col items-center">
//         <FaUserCircle className="text-3xl" />
//         <span className="text-sm font-semibold text-gray-700 mt-1">abhishek</span>
//       </div>
//     </div>
//   );
// }
...
//       pathname === path ? 'text-blue-700' : 'hover:bg-gray-100 hover:text-blue-700'
//     }`;
...
//               <Link href="/skill-test" className={`${linkStyles('/skill-test')} font-bold`}>Skill Test</Link> {/* Bold text */}
//             </li>
//             <li className="flex items-center py-2">
