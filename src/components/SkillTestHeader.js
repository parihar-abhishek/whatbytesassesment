...
//         <button
//           onClick={openModal}
//           className="bg-[#32174D] text-white px-4 py-1 rounded-md hover:bg-[#32174D]"
//         >
//           Update
//         </button>
//       </div>
...
//               <button
//                 onClick={handleSave}
//                 className="px-4 py-2 bg-[#32174D] text-white rounded-md hover:bg-[#32174D]"
//               >
//                 Save
//               </button>
//             </div>
...
//           <Image src={htmlImage} width={50} height={50} alt="HTML Icon" />
//           <div>
//             <h2 className="text-xl md:text-2xl font-bold mb-1">Hyper Text Markup Language</h2>
//             <p className="text-sm text-gray-700">
//               Questions: 08 | Duration: 15 mins | Submitted on 5 June 2021
//             </p>
//           </div>
